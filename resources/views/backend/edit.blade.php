                            ...
                            <div class="project-wrapper">
                                <div class="project">
                                    <div class="photo-wrapper">
                                        <div class="photo">
                                            <a class="fancybox" href="{{ asset('images/logo.png') }}"><img class="img-responsive" src="{{ asset('images/vg2.png') }}" alt=""></a>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
                            <div class="project-wrapper">
                                <div class="project">
                                    <div class="photo-wrapper">
                                        <div class="photo">
                                            <a class="fancybox" href="{{ asset('images/logo.png') }}"><img class="img-responsive" src="{{ asset('images/logo.png') }}" alt=""></a>
                                        </div>
                                        <div class="overlay"></div>
                                    </div>
                                </div>
                ...
                <div class="row mt">
                    <div class="col-lg-12">
                            <textarea name="editor1" id="isi"><h3>Lorem Ipsum: when, and when not to use it</h3>
                                ...
                                <p><img alt="" class="responsive" src=" {{ asset('images/post-4.jpg') }} " style="height:400px; width:600px" /></p>
